<script>  
  ...
  let items = [
    {
      nombre: 'Paquete 4',
      pyd: ['2 tostadas y 1 gordita de res.', 'Torta ahogada de cochinita.','Hamburguesa con queso y papas fritas.', 'Chilaquiles rojos con pollo.'],
      precio: "$191"
    },
    {
      nombre: 'Paquete 5',
      pyd: ['Asado a la plaza de res.', 'El Danzante.', 'Pozole.'],
      precio: "$212"
    },
    {
      nombre: 'Paquete 6',
      pyd: ['Torta mexicana.', 'Tabachín.','Limiburger'],
      precio: "$232"
    },
    {
      nombre: 'Paquete 7',
      pyd: ['Barbacoa', 'Lomo relleno'],
      precio: "$303"
    },
  ];
