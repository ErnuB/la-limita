<script>
  export let images = [
    { path: "/img/empresarial/img1.jpg", description: "La Limita" },
    { path: "/img/empresarial/img2.jpg", description: "La Limita" },
    { path: "/img/empresarial/img3.jpg", description: "La Limita" },
    { path: "/img/empresarial/img4.jpg", description: "La Limita" },
    { path: "/img/empresarial/img5.jpg", description: "La Limita" },
  ];
